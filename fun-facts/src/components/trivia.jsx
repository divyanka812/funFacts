...
const Trivia = ({ triviaData, triviaLoader, getRandomFacts, error = "" }) => {
      ...
      <div className="flex mx-10 my-5 h-max">
        <div className="w-1/2 rounded-l-lg bg-yellow-200 p-3">
          <div className="flex flex-col gap-y-3">
            <h1 className="font-bold text-2xl">Select a category to get you riddle</h1>
            <div className="flex flex-col justify-center gap-3">
            <label className="text-base font-medium">Choose a category of the riddle</label>
            ...
            <div className="flex justify-center ">
              ...
              <label className="text-base font-medium">Or get your riddle even without selecting a category</label>
            </div>
